...
class Pdf {
    ...
    public function __construct(){
        ...
        $defines = \Config::get('laravel-pdf::defines') ?: array();
        ...
        $config_file = \Config::get('laravel-pdf::config_file') ?: base_path() .'/vendor/dompdf/dompdf/dompdf_config.inc.php';
        ...
        if(\Config::has('laravel-pdf::paper')){
            $this->paper = \Config::get('laravel-pdf::paper');
        }else{
            $this->paper = DOMPDF_DEFAULT_PAPER_SIZE;
        }

        $this->orientation = \Config::get('laravel-pdf::orientation') ?: 'portrait';
